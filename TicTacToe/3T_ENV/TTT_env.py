...
def train_action_mask(env_fn, steps=10_000, seed=0, **env_kwargs):
    ...
    model = MaskablePPO(MaskableActorCriticPolicy, env, verbose=1, tensorboard_log="./ppo_3t_tensorboard/")
    model.set_random_seed(seed)
    model.learn(total_timesteps=steps,progress_bar=True, tb_log_name="None_entropy")
...
if __name__ == "__main__":
    ...
    train_action_mask(env_fn, steps=5000000, seed=0, **env_kwargs)
